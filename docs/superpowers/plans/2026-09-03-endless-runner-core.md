...
**Goal:** Build the first playable 2D side-scrolling endless-runner slice in `/mnt/e/GodotProjects/cool-run`.
...
- Godot project path is `/mnt/e/GodotProjects/cool-run` and is currently empty.
...
**Files:**
- Create: `/mnt/e/GodotProjects/cool-run/project.godot`
...
- [ ] **Step 1: Write the project configuration**
  ...
  Set `config/name` to `Cool Run`, `run/main_scene` to `res://scenes/main.tscn`, `display/window/size/viewport_width` to `960`, `display/window/size/viewport_height` to `540`, and stretch mode to `canvas_items`.
...
- [ ] **Step 3: Run the static project check**
  ...
  Run: `godot --headless --path /mnt/e/GodotProjects/cool-run --editor --quit`
...
**Files:**
- Create: `/mnt/e/GodotProjects/cool-run/scripts/art_provider.gd`
- Create: `/mnt/e/GodotProjects/cool-run/scripts/player.gd`
- Create: `/mnt/e/GodotProjects/cool-run/scripts/obstacle.gd`
...
**Files:**
- Create: `/mnt/e/GodotProjects/cool-run/scenes/main.tscn`
- Create: `/mnt/e/GodotProjects/cool-run/scripts/main.gd`
...
- [ ] **Step 5: Run a headless launch check**
  ...
  Run: `timeout 8s godot --headless --path /mnt/e/GodotProjects/cool-run --quit-after 5`
...
**Files:**
- Create: `/mnt/e/GodotProjects/cool-run/scripts/hud.gd`
- Modify: `/mnt/e/GodotProjects/cool-run/scenes/main.tscn`
...
- [ ] **Step 4: Run manual runtime checks**
  ...
  Run: `godot --path /mnt/e/GodotProjects/cool-run`
...
- [ ] **Step 2: Run fresh runtime verification**
  ...
  Launch with `godot --path /mnt/e/GodotProjects/cool-run`, exercise start, jump, clear, collision, score, keyboard restart, and touch restart, then capture `KECO_OBSERVATION` output.
