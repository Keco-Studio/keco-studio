...
The internal validators consume the current V2 status and evaluation artifacts
for release gates. These artifacts remain machine evidence and do not change
the new user-facing layout.
