...
const MODULES = [
  {
    ...
    nameEn: 'Overview',
    icon: <HomeOutlined />,
    path: '/economy-simulator',
    description: '经济系统总览与关键指标',
    color: '#722ed1',
  },
  {
    id: 'characters',
    name: '角色养成 / Characters',
    nameEn: 'Characters',
    icon: <UserOutlined />,
    path: '/economy-simulator/characters',
  ...
  },
  {
    ...
    path: '/economy-simulator/equipment',
  ...
  },
  {
    ...
    nameEn: 'Prestige',
    icon: <StarOutlined />,
    path: '/economy-simulator/prestige',
  ...
  },
  {
    ...
    path: '/economy-simulator/calculator',
...
export default function EconomySimulatorPage() {
  // 使用 useSearchParams 获取当前路径需要在客户端组件中处理
  // 这里简化为直接使用静态渲染
