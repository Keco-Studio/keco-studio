/** Shared document-reference glyph — inline SVG so Lexical/MDX re-renders never blank an Image load. */

export type DocumentReferenceIconProps = {
  size?: number;
  className?: string;
};

export function DocumentReferenceIcon({
  size = 14,
  className,
}: DocumentReferenceIconProps) {
  return (
    <svg
      width={size}
      height={size}
