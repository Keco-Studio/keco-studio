...
export const SIM_FIELDS: Record<LibraryRole, readonly SimulationFieldDefinition[]> = {
  characters: [
    { id: 'id', label: 'Character ID', required: true },
    { id: 'name', label: 'Name', required: true },
    { id: 'cls', label: 'Class' },
    { id: 'el', label: 'Element', required: true },
    { id: 'hp', label: 'Base HP', required: true },
    { id: 'atk', label: 'Base ATK', required: true },
    { id: 'def', label: 'Base DEF', required: true },
    { id: 'spd', label: 'Base SPD', required: true },
    { id: 'mp', label: 'Base MP', required: true },
  ],
  skills: [
    { id: 'id', label: 'Skill ID', required: true },
    { id: 'name', label: 'Name', required: true },
    { id: 'el', label: 'Element', required: true },
    { id: 'mp', label: 'MP Cost', required: true },
    { id: 'power', label: 'Power', required: true },
    { id: 'cd', label: 'Cooldown', required: true },
    { id: 'kind', label: 'Type', required: true, allowedValues: ['dmg', 'heal', 'buff'] },
    { id: 'status', label: 'Status', allowedValues: ['burn', 'dot', 'freeze', 'stun', ''] },
    { id: 'fx', label: 'Effect' },
  ],
  level: [
    { id: 'level', label: 'Level', required: true },
    { id: 'exp', label: 'EXP Required', required: true },
    { id: 'sp', label: 'SP Grant', required: true },
  ],
  skillc: [
    { id: 'lv', label: 'Skill Level', required: true },
    { id: 'cost', label: 'SP Cost', required: true },
  ],
};
