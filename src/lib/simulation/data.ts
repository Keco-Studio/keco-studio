...
export const LIB_DEFS: ReadonlyArray<{
  ...
  { key: 'level', label: 'Character curve', hint: 'thresholds & SP grants', opts: ['Character curve — standard', 'Character curve — fast', 'Character curve — hardcore'] },
...
export const SIM_FIELDS: Record<LibraryRole, readonly SimulationFieldDefinition[]> = {
  characters: [
    { id: 'id', label: 'ID', required: true, aliases: ['id', 'character id', 'char id'], valueTypes: ['string'] },
    { id: 'name', label: 'Name', required: true, aliases: ['name', 'display name', 'character name'], valueTypes: ['string'] },
    { id: 'el', label: 'Element', required: true, aliases: ['el', 'element'], valueTypes: ['string', 'enum'] },
    { id: 'hp', label: 'HP', required: true, aliases: ['hp', 'base hp', 'health'], valueTypes: ['number'] },
    { id: 'atk', label: 'Attack', required: true, aliases: ['atk', 'base atk', 'attack'], valueTypes: ['number'] },
    { id: 'def', label: 'Defense', required: true, aliases: ['def', 'base def', 'defense'], valueTypes: ['number'] },
    { id: 'spd', label: 'Speed', required: true, aliases: ['spd', 'base spd', 'speed'], valueTypes: ['number'] },
    { id: 'mp', label: 'MP', required: true, aliases: ['mp', 'base mp', 'mana'], valueTypes: ['number'] },
  ],
  skills: [
    { id: 'id', label: 'ID', required: true, aliases: ['id', 'skill id'], valueTypes: ['string'] },
    { id: 'name', label: 'Name', required: true, aliases: ['name', 'skill name', 'display name'], valueTypes: ['string'] },
    { id: 'el', label: 'Element', required: true, aliases: ['el', 'element'], valueTypes: ['string', 'enum'] },
    { id: 'mp', label: 'MP', required: true, aliases: ['mp', 'mp cost', 'mana cost'], valueTypes: ['number'] },
    { id: 'power', label: 'Power', required: true, aliases: ['power', 'power value', 'damage'], valueTypes: ['number'] },
    { id: 'cd', label: 'Cooldown', required: true, aliases: ['cd', 'cooldown'], valueTypes: ['number'] },
    { id: 'kind', label: 'Type', required: true, aliases: ['kind', 'type', 'skill type'], allowedValues: ['dmg', 'heal', 'buff'], valueTypes: ['string', 'enum'] },
    { id: 'status', label: 'Status', aliases: ['status', 'status effect'], allowedValues: ['burn', 'dot', 'freeze', 'stun', ''], valueTypes: ['string', 'enum'] },
    { id: 'fx', label: 'Effect', aliases: ['fx', 'effect', 'effect description'], valueTypes: ['string'] },
  ],
  level: [
    { id: 'characterId', label: 'Character ID', aliases: ['character_id', 'character id', 'char id'], valueTypes: ['string'] },
    { id: 'level', label: 'Level', required: true, aliases: ['level', 'level number', 'lv'], valueTypes: ['number'] },
    { id: 'exp', label: 'EXP', required: true, aliases: ['exp', 'exp required', 'experience'], valueTypes: ['number'] },
    { id: 'sp', label: 'SP', required: true, aliases: ['sp', 'sp grant', 'skill points'], valueTypes: ['number'] },
  ],
  skillc: [
    { id: 'skillId', label: 'Skill ID', required: true, aliases: ['skill_id', 'skill id'], valueTypes: ['string'] },
    { id: 'lv', label: 'Level', required: true, aliases: ['lv', 'skill level', 'level'], valueTypes: ['number'] },
    { id: 'cost', label: 'Cost', required: true, aliases: ['cost', 'upgrade cost', 'sp cost', 'upgrade sp'], valueTypes: ['number'] },
  ],
};
