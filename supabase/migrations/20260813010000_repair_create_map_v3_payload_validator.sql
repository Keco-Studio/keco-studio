-- Repair partially installed Create Map V3 validators without touching retained data.

do $$
begin
  if to_regprocedure('public.map_validate_v3_payload_without_collision_grid(jsonb,jsonb)') is null then
