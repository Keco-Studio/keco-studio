...
test.describe('Resource Creation Authorization', () => {
  ...
  test('should prevent creating project without authentication via API', async ({ request }) => {
    // Attempt to create a project without authentication
  ...
  test('should prevent accessing project details without authentication via API', async ({ request }) => {
    const fakeProjectId = 'fake-project-id-12345';
  ...
  test('should prevent deleting project without authentication via API', async ({ request }) => {
    const fakeProjectId = 'fake-project-id-12345';
...
test.describe('Session Management', () => {
  ...
  test('should not allow browser back button to access protected pages after logout', async ({ page }) => {
    const loginPage = new LoginPage(page);
